...
var Note = {
	...
	fixNoteContent: function(content) {
		...
		var reg1 = new RegExp(url + '/api/file/getImage', 'g');
		content = content.replace(reg1, Evt.getImageLocalUrlPrefix());
		...
		// http://localhost:xxx --> http://url
		var reg5 = new RegExp("http://localhost[:0-9]*", 'g');
		content = content.replace(reg5, url);
	...
	fixNoteContentForSend: function(content) {
		...
		content = content.replace(reg, '/api/file/getImage');

		var reg2 = new RegExp(Evt.getAttachLocalUrlPrefix(), 'g');
		content = content.replace(reg2, '/api/file/getAttach');

		var reg3 = new RegExp(Evt.getAllAttachsLocalUrlPrefix(), 'g');
		content = content.replace(reg3, '/api/file/getAllAttachs');
